/**
 * /api/forex/drawings — CRUD для рисунков на форекс-графике.
 * Тот же lib/drawings.ts, что и /api/orderflow/drawings, но exchange="forex"
 * и symbol допускает форекс-формат "EUR/USD" (со слэшем).
 *
 * GET    ?symbol=X  — список рисунков
...
/** GET — список рисунков для symbol */
