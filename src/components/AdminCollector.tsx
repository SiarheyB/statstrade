...
// Тяжёлая часть ответа кэшируется на сервере 10 секунд (HEAVY_TTL_MS в роуте),
// а «фид отстал» — это порог в 90 секунд (FEED_STALE_MS). Опрашивать чаще
// кэша нечем: две трети запросов возвращали одно и то же, а каждый всё равно
// проходил через авторизацию и превью стакана.
