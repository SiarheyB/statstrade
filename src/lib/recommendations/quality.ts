...
export const DEFAULT_THRESHOLDS: QualityThresholds = {
  ...
  // По решению трейдера — любой настоящий прокол вчера (глубже шума, как
  // minPierceAtr): цена только что собрала стопы за уровнем, и пробой нужно
  // подтвердить хотя бы одним днём, в который уровень не трогали
  // (ZHIPUUSDT: прокол 0.17×ATR проходил старый порог 0.3).
  unconfirmedPierceAtr: 0.08,
